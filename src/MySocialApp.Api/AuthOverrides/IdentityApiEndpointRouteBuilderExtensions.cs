        ...
        where TUser : class, new()
    {
        ...
        if (!configureOptions.ExcludeRegisterPost)
        {
            ...
            routeGroup.MapPost("/register", async Task<Results<Ok, ValidationProblem>>
                ([FromBody] MySocialAppRegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
            {
        ...
        if (!configureOptions.ExcludeLoginPost)
        {
            ...
            ([FromBody] MySocialAppLoginRequest login, [FromQuery] bool? useCookies, [FromQuery] bool? useSessionCookies, [FromServices] IServiceProvider sp) =>
            {
